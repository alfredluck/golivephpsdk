...
class LogManager implements LoggerInterface
{
    ...
    {
        return new Monolog('Alfredluck', $this->prepareHandlers([new StreamHandler(
            \sys_get_temp_dir().'/Alfredluck/Alfredluck.log',
